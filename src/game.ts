...
document.querySelector<HTMLDivElement>('#app')!.innerHTML = `
    <div class="min-h-screen bg-cover bg-center bg-fixed bg-no-repeat flex items-center justify-between p-8">
        <div class="relative bg-black rounded-3xl shadow-2xl p-6 max-w-5xl w-full max-h-[70vh]">
            <div class="bg-black rounded-2xl h-full p-4">
                <div class="flex h-full gap-4">
                    ...
                    <div class="flex-1 bg-gray-900 rounded-lg border border-gray-700 flex items-center justify-center p-4">
                        <img src=""
                             alt=""
        ...
        <div class="flex flex-col items-center mt-8">
            <div class="text-gray-950 text-lg tracking-widest text-center mb-2">
                --------------------------------------------------------------------------------
            </div>
